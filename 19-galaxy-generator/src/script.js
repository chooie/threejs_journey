...
function generateGalaxy() {
  ...
  // Each position needs 3 coordinates, so we have to multiply count by 3
  const positionsCount = parameters.count * 3;
  const positions = new Float32Array(positionsCount);
  const colors = new Float32Array(positionsCount);
  ...
  console.log("Generated the galaxy");
}
